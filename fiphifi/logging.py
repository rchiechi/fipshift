...
class FipFormatter(logging.Formatter):
    ...
    def format(self, record):
        ...
        if record.levelno == logging.DEBUG:
            self._style._fmt = FipFormatter.dbg_fmt

        elif record.levelno == logging.INFO:
            self._style._fmt = FipFormatter.info_fmt

        elif record.levelno == logging.WARNING:
            self._style._fmt = FipFormatter.wrn_fmt

        elif record.levelno == logging.ERROR:
            self._style._fmt = FipFormatter.err_fmt
